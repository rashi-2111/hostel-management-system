...
def main():
    ...
    def add_stud():
        ...
        vehicle = Label(base, text="Vehicle", font=("Arial 15 bold"), bg="silver", fg="black")
    ...
    def visitor():
        ...
        v_relation = Label(base, text="Relation", font=("Arial 20 bold"), bg="silver", fg="black")
        v_relation.place(x=500, y=400)
        v_relation_entry = Entry(base, width=20, font=("Arial 20 bold"))
        v_relation_entry.place(x=650, y=400)
